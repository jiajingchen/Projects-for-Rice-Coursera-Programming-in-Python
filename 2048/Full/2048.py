...
class TwentyFortyEight:
    ...
    def __init__(self, grid_height, grid_width):
        ...
        self._grid=[]
        self._initi_tiles={}# create a dictionary of the indices for the initial tiles in each direction
    ...
    def reset(self):
        ...
        for dummy_i in range(0,self._height):
            self._grid.append(self._width*[0])
    ...
    def move(self, direction):
        ...
        for item in self._initi_tiles[direction]:
            ...
            for num in range(indice_range):
                ...
                temporary_list.append(self._grid[indice_list[num][0]][indice_list[num][1]])
            
            merge_list=merge(temporary_list)
             
            for num in range(indice_range):
                if self._grid[indice_list[num][0]][indice_list[num][1]]!=merge_list[num]:
                    move_flag+=1
                self._grid[indice_list[num][0]][indice_list[num][1]]=merge_list[num]
