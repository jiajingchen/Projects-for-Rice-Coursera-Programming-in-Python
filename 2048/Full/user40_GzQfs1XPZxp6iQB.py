...
class TwentyFortyEight:
    ...
    def __init__(self, grid_height, grid_width):
        ...
        self.grid=[]
        self.INITI_TILES={}# create a list of the indices for the initial tiles in each direction
        
        self.INITI_TILES[UP]= [(0, index) for index in range(self.width)]
        self.INITI_TILES[DOWN]= [(self.height-1, index) for index in range(self.width)]
        self.INITI_TILES[LEFT]= [(index,0) for index in range(self.height)]
        self.INITI_TILES[RIGHT]= [(index, self.width-1) for index in range(self.height)]
    ...
    def move(self, direction):
        ...
        for item in self.INITI_TILES[direction]:
            temporary_list=[]
            indice_list=[]
