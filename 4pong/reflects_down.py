...
def draw(canvas):
    ...
    if paddle1_pos+paddle1_vel<=HEIGHT-PAD_HEIGHT+2 and paddle1_pos+paddle1_vel>HEIGHT-PAD_HEIGHT-2:
        paddle1_pos+= paddle1_vel
        print "!!"
    if paddle2_pos+paddle1_vel<=HEIGHT-PAD_HEIGHT and paddle2_pos+paddle2_vel>HEIGHT-PAD_HEIGHT:
