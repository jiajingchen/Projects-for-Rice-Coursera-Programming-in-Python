...
def pick_random_move(board,player):
    ...
    if board.get_empty_squares()!=[]:# if there is an empty space to make a move
...
board1=provided.TTTBoard(3,False,None)
board1.move(0,0,provided.PLAYERO)
board1.move(1,1,provided.PLAYERO)
print board1
#mc_trial(board1,provided.PLAYERX)
print mc_move(board1,provided.PLAYERX, 100)
...
print provided.switch_player(provided.PLAYERX)
