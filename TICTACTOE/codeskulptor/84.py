...
def pick_random_move(board,player):# if there is an empty space to make a move
...
def mc_trial(board, player):#This function takes a current board and the next player to move
...
def get_best_move(board, scores):#find all of the empty squares with the maximum score
